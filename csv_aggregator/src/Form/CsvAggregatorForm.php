...
namespace Drupal\csv_aggregator\Form;

use Drupal\Core\Form\ConfigBaseForm;
use Drupal\Core\Form\FormStateInterface;

class CsvAggregatorForm extends ConfigFormBase {
  
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'csv_aggregator_config_form';
  }
  ...
  public function getEditableConfigNames() {
    return ['csv_aggregator.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('csv_aggregator.settings');
    ...
    $form['field_to_aggregate'] = [
      '#type'  => 'textfield',
      '#title' => $this->t('Field to aggregate.'),
